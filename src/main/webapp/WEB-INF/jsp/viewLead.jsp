...
<table id="myTable" class="tablesorter">
	<tbody>
		<tr>
			<td class="align-left"><B>LeadDate:</B><c:out
				value="${leadHeader.createdStamp}" /></td>
			<td class="align-left"><B>Status:</B><c:out
				value="${leadHeader.statusId}" /></td>
			<td class="align-left"><B>PreferredNoOfGuest:</B><c:out
				value="${leadHeader.pre_no_of_guest}" /></td>
			<td class="align-left"><B>PreferredDate:</B><c:out
				value="${leadHeader.preferDate}" /></td>
		</tr>
		<tr>
			<td class="align-left"><B>FromChannel:</B><c:out
				value="${leadHeader.fromChannel}" /></td>
			<td class="align-left"><B>Budget:</B><c:out
				value="${leadHeader.budget}" /></td>
		</tr>
	</tbody>
</table>
</div>
...
<table id="myTable" class="tablesorter">
	<tbody>
		<c:forEach var="leadContact" items="${leadHeader.contactInfo}">
			<tr>
				<td class="align-left"><B>LeadName:</B><c:out
					value="${leadContact.clientName}" /></td>
				<td class="align-left"><B>ContactInfo:</B><c:out
					value="${leadContact.addressInfo}" /></td>
				<td class="align-left"><B>Email:</B><c:out
					value="${leadContact.emailId}" /></td>
				<td class="align-left"><B>Phone No:</B><c:out
					value="${leadContact.phoneNumber}" /></td>
			</tr>
		</c:forEach>
	</tbody>
</table>
...
<table id="myTable" class="tablesorter">
	<tbody>
		<c:forEach var="leadHist" items="${leadHeader.leadHistory}">
			<tr>
				<td class="align-left"><B>Created Date:</B><c:out
					value="${leadHist.createdStamp}" /></td>
				<td class="align-left"><B>Status:</B><c:out
					value="${leadHist.statusId}" /></td>
				<td class="align-left"><B>Assigned From:</B><c:out
					value="${leadHist.assignedFrom}" /></td>
				<td class="align-left"><B>Assigned To:</B><c:out
					value="${leadHist.assignedTo}" /></td>
			</tr>
		</c:forEach>
	</tbody>
</table>
...
<table id="myTable" class="tablesorter">
	<tbody>
		<c:forEach var="leadAlliedServices"
			items="${leadHeader.alliedService}">
			<tr>
				<td class="align-left"><B>Allied Services:</B><c:out
					value="${leadAlliedServices.alliedServiceComposite.alliedServicesId}" /></td>
			</tr>
		</c:forEach>
	</tbody>
</table>
